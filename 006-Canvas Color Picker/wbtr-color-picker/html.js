const html = `
		...
		<div class="cpicker wrapper" data-id="cpicker">
			...
			<div class="cpicker-gradient" data-id="cpicker-gradient">
				...
				<input data-id="cpicker-gradient-input" type="range" min="0.00" max="1.00" step="0.01" value="0.66"> <!-- why min 0, max 1, i think 271 max -->
			</div>
			...
			<div class="cpicker-code">
				...
				<div class="cpicker-code-inputs">
					<div class="cpicker-code-input cpicker-code-hex show">
					...
					<div class="cpicker-code-input cpicker-code-css">
